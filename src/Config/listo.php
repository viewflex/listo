...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Listo Global Configuration Defaults
    |
    | These settings provide the defaults for Listo's global configuration,
    ...
    */
    ...
    'contexts'          => [
        'items'             => '\Viewflex\Listo\Publish\Demo\Items\ItemsContext'
    ]
